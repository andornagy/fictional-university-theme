...
class MyNotes {
  ...
  makeNoteReadonly(thisNote) {
    thisNote.find(".edit-note").html('<i class="fa fa-pencil" aria-hidden="true"></i> Edit Note');
      ...
      this.resultsDiv.html(`
         <div class="row">
            <div class="one-third">
               ...
               ${results.generalInfo.length ? '<ul class="link-list min-list">' : "<p>No posts found</p>"}
